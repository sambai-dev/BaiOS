...
const defaultNodes: readonly FileNode[] = [
  {
    ...
    summary: "Notes, folders, and shortcuts saved in this browser.",
  },
  {
    id: TRASH_FILE_ID,
    kind: "trash",
  ...
  },
  {
    ...
    createdAt: DEFAULT_TIMESTAMP,
    updatedAt: DEFAULT_TIMESTAMP,
    summary: "About Sam and his work in Hamilton, New Zealand.",
  },
  {
    ...
    createdAt: DEFAULT_TIMESTAMP,
    updatedAt: DEFAULT_TIMESTAMP,
    summary: "How I think about building software.",
    content:
  ...
  },
  {
    ...
    createdAt: DEFAULT_TIMESTAMP,
    updatedAt: DEFAULT_TIMESTAMP,
    summary: "Meet Sam and see what he is working on.",
  },
  {
    id: "folder-solynth",
    kind: "folder",
  ...
  },
  {
    ...
    createdAt: DEFAULT_TIMESTAMP,
    updatedAt: DEFAULT_TIMESTAMP,
    summary: "Visit the Solynth Labs website.",
  },
  {
    id: "folder-trekky",
    kind: "folder",
    ...
    createdAt: DEFAULT_TIMESTAMP,
    updatedAt: DEFAULT_TIMESTAMP,
    summary: "A job-search product from Solynth Labs.",
  },
  {
    id: "note-trekky-product",
    kind: "note",
    name: "Building Trekky",
    parentId: "folder-trekky",
    createdAt: DEFAULT_TIMESTAMP,
    updatedAt: DEFAULT_TIMESTAMP,
    summary: "How releases and feedback shape the product.",
    content:
  ...
  },
  {
    ...
    createdAt: DEFAULT_TIMESTAMP,
    updatedAt: DEFAULT_TIMESTAMP,
    summary: "From a first question to working software.",
    content:
  ...
  },
  {
    ...
    createdAt: DEFAULT_TIMESTAMP,
    updatedAt: DEFAULT_TIMESTAMP,
    summary: "Explore how Sam approaches a project.",
  },
  {
    id: "folder-systems",
    kind: "folder",
    ...
    createdAt: DEFAULT_TIMESTAMP,
    updatedAt: DEFAULT_TIMESTAMP,
    summary: "Explore Trekky, the Workbench, and a motion experiment.",
  },
  {
    ...
    createdAt: DEFAULT_TIMESTAMP,
    updatedAt: DEFAULT_TIMESTAMP,
    summary: "Games, visual tools, and interaction experiments.",
  },
  {
  ...
  },
  {
    ...
    createdAt: DEFAULT_TIMESTAMP,
    updatedAt: DEFAULT_TIMESTAMP,
    summary: "Outline a project and prepare an email to Sam.",
  },
  {
    id: "shortcut-sandbox",
    kind: "app",
